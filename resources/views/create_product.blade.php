            ...
            <div class="card-body">
                <form method="POST" action="{{route('product.store')}}" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input id="name" name="name" type="text" class="form-control" placeholder="e.g., The Cloud Comfort Mattress" required>
                    </div>

                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label for="quantity" class="form-label">Quantity in Stock</label>
                            <input id="quantity" name="quantity_in_stock" type="number" class="form-control" placeholder="e.g., 50" required>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="price" class="form-label">Unit Price</label>
                            <div class="input-group">
                                <span class="input-group-text">$</span>
                                <input id="price" name="price" type="number" step="0.01" class="form-control" placeholder="e.g., 999.99" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea id="desc" name="desc" class="form-control" rows="3" placeholder="A brief description of the product..."></textarea>
                    </div>
