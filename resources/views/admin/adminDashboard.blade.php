...
<x-app-layout>
    ...
    <div class="card-header border-0 bg-white p-4">
        <h3 class="h5 font-weight-semibold text-dark mb-0 text-center">Quick Actions</h3>
    </div>
            <div class="card-body p-4">
                <div class="row g-4 justify-content-center">  
                    <div class="col-12 col-sm-6 col-md-4 col-lg-3"> 
                        <a href="{{ route('product.create') }}" class="d-flex flex-column align-items-center p-3 text-decoration-none rounded-3 quick-action-item h-100">
                            ...
                            <h6 class="mb-0 text-dark text-center">Add New Product</h6> 
                            <p class="small text-muted mt-1 text-center">Create a new listing</p>
                        </a>
                    </div>
                    
                    <div class="col-12 col-sm-6 col-md-4 col-lg-3">  
                        <a href="{{ route('company.create') }}" class="d-flex flex-column align-items-center p-3 text-decoration-none rounded-3 quick-action-item h-100">
                            <div class="p-3 mb-3 bg-light rounded-circle d-flex align-items-center justify-content-center">
                            ...
                            <h6 class="mb-0 text-dark text-center">Register Company</h6>  
                            <p class="small text-muted mt-1 text-center">Add a new supplier</p>  
                        </a>
                    </div>
                </div>
            </div>
